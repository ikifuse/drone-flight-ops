...
| [34i 人員登録・本人編集](34i_person-registration-and-account-linking.md) | 個人本人のGoogleアカウント欄省略、他人・会社の任意欄、保存・取消への引継ぎ（限定範囲） |
...
2026-09-23の入力横断監査：[34f §8](34f_screen-map-and-design-coverage.md#8-入力項目取得タイミングの横断監査2026-09-23)から、必須性と取得時点、固定情報の後補完、実績への引継ぎと未検証範囲を辿れる。
