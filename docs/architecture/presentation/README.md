...
最終更新: 2026-09-18\
範囲: Step 1の10項目規約、Step 2の人物・環境・権限への接続、Step 5の§3と§7の通常画面・共有リスト限定部分。C1未着手。
...
Step 6で通常運航の10項目画面仕様を[35b](../operation-recording/35b_normal-operation-and-final-save.md)へ追加した。34dから点検以降へ接続し、Drive全体は[37](../drive-structure/37_environment-storage-responsibilities.md)が正本。上の「対象外」はStep 5の確認範囲を表す。
