...
| [ADR-0001](ADR-0001-architecture-selection.md) | 総合運航管理システムのアーキテクチャ選定 | **提案中** | 2026-09-14 | PWA ＋ Cloudflare Workers ＋ ローカルDB・スプレッドシートハイブリッド構成の選定 |
| ADR-0002 | （Phase B2にて作成予定） | 未着手 | - | データモデル・IndexedDBスキーマ設計 |
