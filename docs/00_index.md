...
| [architecture/27_output-kml-drive-and-mymaps.md](architecture/27_output-kml-drive-and-mymaps.md) | **出力・KML・Google Drive・My Maps連携設計** | 3大出力系統分離（Sheets台帳/PDF帳票/KML）、1計画1KML、Drive自動保存、My Maps手動連携、機体ログ重畳 | Geo Export実装時、Drive連携時、My Maps運用時 | **確定** | kml, google-drive, my-maps, geo-export, output |
