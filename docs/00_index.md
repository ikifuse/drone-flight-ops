...
| [移植記録README](migration/README.md) | 99.2再移植の対象・根拠・移管先・検査 | 監査記録 / Step 1〜7c |
...
│   └── ADR-0001〜0009 / 0015〜0024 # 既存決定と再移植のProposed記録（0010〜0014はmainに保全）
└── architecture/
    ...
    ├── presentation/           # 10項目規約・初回・ホーム・共有リスト・正常受付後
    ...
    ├── output/                 # 出力境界 / KML / KML生成契機・内容 / Drive / My Maps / 機体ログ
