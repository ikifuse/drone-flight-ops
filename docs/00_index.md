...
| [architecture/README.md](architecture/README.md) | アーキテクチャ検討目次 | Phase B1/B1.2（技術構成比較・最終事実訂正）の概要・目的・ドキュメント構成 | B1全体の把握時、B2着手前 | **確定** | アーキテクチャ設計 |
| [architecture/00_b1-audit-and-corrections.md](architecture/00_b1-audit-and-corrections.md) | B1.2最終事実訂正・監査記録 | DIPS仕様・申請主体・Workers制限・オフライン通報・正本モデルの客観的整理 | 技術選定の前提確認時、B2設計着手前 | **確定** | アーキテクチャ全体、監査 |
